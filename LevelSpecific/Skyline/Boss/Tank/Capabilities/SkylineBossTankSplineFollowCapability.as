class USkylineBossTankSplineFollowCapability : USkylineBossTankChildCapability
{
	default CapabilityTags.Add(SkylineBossTankTags::SkylineBossTankMovement);
	default CapabilityTags.Add(SkylineBossTankTags::SkylineBossTankSplineFollow);
	...
	void Setup()
	{
		...
		SplineFollowComp = USkylineBossTankSplineFollowComponent::Get(BossTank);	
	}

	UFUNCTION(BlueprintOverride)
	bool ShouldActivate() const
	{
		if (SplineFollowComp.CurrentSpline == nullptr)
			return false;
	...
	{
		FVector ToTarget = (SplineFollowComp.GetTargetOnSpline() - BossTank.ActorLocation).ConstrainToPlane(FVector::UpVector);
