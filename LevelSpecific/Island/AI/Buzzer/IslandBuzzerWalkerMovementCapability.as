class UIslandBuzzerWalkerMovementCapability : UBasicAIMovementCapability
{	
	...
	void Setup()
	{
		...
		BuzzerComp = UIslandBuzzerWalkerComponent::Get(Owner);
	}
	...
	void TickActive(float DeltaTime)
	{
		...
		BuzzerComp.SpawnImpulse = FVector::ZeroVector;
	}
	...
	void ComposeMovement(float DeltaTime) override
	{
		...
		// There's delay from spawn until first movement tick, so we can't use regular movement impulses
		Velocity += BuzzerComp.SpawnImpulse;
