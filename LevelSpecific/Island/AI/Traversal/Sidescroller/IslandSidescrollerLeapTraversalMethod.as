class UIslandSidescrollerLeapTraversalMethod : UTraversalMethod
{
	...
	{
		// Assumes we have sidescrolling along XZ-plane.
		FVector Up = FVector::UpVector;
		FVector OutwardsDir = Pathfinding::GetOutwardsEdgeDirection(Edge, Up);
		Debug::DrawDebugArrow(Edge.Center, Edge.Center + OutwardsDir*100, Duration = 10.0);		
		if (OutwardsDir != FVector::ForwardVector && OutwardsDir != FVector::BackwardVector)
			return false;
