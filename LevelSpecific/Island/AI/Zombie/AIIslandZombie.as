UCLASS(Abstract)
class AAIIslandZombie : ABasicAIGroundMovementCharacter
{
	...
	default CapabilityComp.DefaultCapabilities.Add(n"IslandZombieBehaviourCompoundCapability");
	...
	UPROPERTY(DefaultComponent)
	UIslandNecromancerReviveTargetComponent RevivableComp;
