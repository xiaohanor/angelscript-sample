...
UCLASS(Abstract)
class UGameplay_Character_Boss_Skyline_TripodMech_Core_Shockwave_SoundDef : USoundDefBase
{
	...
	{
		return Shockwave.Scale * 100.0 > (Shockwave.Radius);
	}

	ASkylineBossShockWave Shockwave;
	...
	void ParentSetup()
	{
		Shockwave = Cast<ASkylineBossShockWave>(HazeOwner);
	}
