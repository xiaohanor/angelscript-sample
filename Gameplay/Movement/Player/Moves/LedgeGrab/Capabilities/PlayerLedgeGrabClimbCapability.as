...
class UPlayerLedgeGrabClimbCapability : UHazePlayerCapability
{
	...
	void OnActivated(FPlayerLedgeGrabClimbActivationParams ActivationParams)
	{
		...
		LedgeGrabComp.ClimbUpState = ActivationParams.ClimbData.bClimbIntoCrouch ? EPlayerLedgeGrabClimbState::ClimbToIdleCrouch : EPlayerLedgeGrabClimbState::ClimbToIdle;
		...
		if (LedgeGrabComp.GetClimbState() == EPlayerLedgeGrabClimbState::ClimbToIdleCrouch)
...
struct FPlayerLedgeGrabClimbActivationParams
{
	FPlayerLedgeGrabClimbData ClimbData;
}