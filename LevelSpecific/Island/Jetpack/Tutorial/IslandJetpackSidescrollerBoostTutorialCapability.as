class UIslandJetpackSidescrollerBoostTutorialCapability : UTutorialCapability
{
	...
	void OnActivated()
	{
		Player.ShowTutorialPromptWorldSpace(Settings.BoostPrompt, this, AttachComponent = TutorialAttachRoot, AttachOffset = Settings.BoostPromptOffset);
	}
