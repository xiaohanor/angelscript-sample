...
class UGameplay_Projectile_Bullet_Impact_IslandBlue_SoundDefAdapter : UIslandRedBlueWeaponBulletEffectHandler
{
	...
	// UFUNCTION(BlueprintOverride)
	// void OnBulletImpactAI(FIslandRedBlueWeaponOnBulletImpactAIParams InParams)
	// {
	// 	//SoundDef.(InParams);
