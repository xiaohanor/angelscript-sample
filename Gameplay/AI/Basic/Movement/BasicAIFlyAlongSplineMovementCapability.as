struct FBasicAIFlyAlongSplineMovementActivateParams
{
	FSplinePosition SplinePosition;
};

class UBasicAIFlyAlongSplineMovementCapability : UBasicAIMovementCapability
{	
	...
	UFUNCTION(BlueprintOverride)
	bool ShouldActivate(FBasicAIFlyAlongSplineMovementActivateParams& Params) const
	{
		...
		Params.SplinePosition = FSplinePosition(DestinationComp.FollowSpline, 0.0, DestinationComp.bFollowSplineForwards);
		return true;		
	}
	...
	UFUNCTION(BlueprintOverride)
	void OnActivated(FBasicAIFlyAlongSplineMovementActivateParams Params)
	{
		Super::OnActivated();
