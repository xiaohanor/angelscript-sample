...
class UTazerBotLandingTargetVisualizerDummyComponent : UActorComponent { }

#if EDITOR
class UTazerBotLandingTargetComponentVisualizer : UHazeScriptComponentVisualizer
{
	default VisualizedClass = UTazerBotLandingTargetVisualizerDummyComponent;
	...
	void VisualizeComponent(const UActorComponent Component)
	{
		...
		ATazerBotLandingTarget LandingTarget = Cast<ATazerBotLandingTarget>(Component.Owner);
