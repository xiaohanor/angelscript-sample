...
UCLASS(Abstract)
class UVO_Summit_HandToHandCombat_MULTI_SoundDef : UHazeVOSoundDef
{
	...
	UFUNCTION(BlueprintEvent)
	void SummitSlidingDoor_OnStartedOpening(){}

	UFUNCTION(BlueprintEvent)
	void SummitSlidingDoor_OnStoppedOpening(){}

	UFUNCTION(BlueprintEvent)
	void SummitSlidingDoor_OnStartedClosing(){}

	UFUNCTION(BlueprintEvent)
	void SummitSlidingDoor_OnStoppedClosing(){}
