...
class UPlayerPoleClimbDash : UHazePlayerCapability
{
	...
	bool ShouldActivate(FPoleClimbJumpUpActivationParams& Params) const
	{
		...
		if(PoleClimbComp.State == EPlayerPoleClimbState::ChainDash && !PoleClimbComp.IsWithinDashChainWindow())
			return false;
...
struct FPoleClimbJumpUpActivationParams
{
	float HeightDelta;
}

struct FPoleClimbJumpUpDeactivationParams
{
	EPlayerPoleClimbJumpUpDeactivationTypes DeactivationType;
}

enum EPlayerPoleClimbJumpUpDeactivationTypes
{
	Cancelled,
	Interrupted,
	MoveCompleted
