...
UCLASS(Abstract)
class UVO_Prison_Boss_DarkMio_GLOBAL_CHASE_SoundDef : UHazeVOSoundDef
{
	...
	UFUNCTION(BlueprintEvent)
	void VolleyProjectileImpact(FPrisonBossVolleyImpactData PrisonBossVolleyImpactData){}

	UFUNCTION(BlueprintEvent)
	void SpawnVolley(FPrisonBossVolleySpawnData PrisonBossVolleySpawnData){}
	...
	UFUNCTION(BlueprintEvent)
	void CloneAttack(FPrisonBossCloneAttackEventData PrisonBossCloneAttackEventData){}
	...
	UHazeAudioAuxBus DarkMioChaseVOProxyBus;

	UFUNCTION()
	bool ShouldActivateDarkMioChaseVOProxy(UObject Owner, FName ProxyTag, float32& outInterpolationTime)
	{
		return true;
	}
	...
	void OnActivated()
	{
		if(DarkMioChaseVOProxyBus != nullptr)
		{
			FHazeProxyEmitterRequest ProxyRequest;
			FOnProxyEmittersRequest RequestDelegate;
			RequestDelegate.BindUFunction(this, n"ShouldActivateDarkMioChaseVOProxy");

			ProxyRequest.AuxBus = DarkMioChaseVOProxyBus;
			ProxyRequest.bRequiresAuxEmitter = true;
			ProxyRequest.bSpatialized = true;
			ProxyRequest.Instigator = this;
			ProxyRequest.Target = this;
			ProxyRequest.OnProxyRequest = RequestDelegate;

			ProxyEmitterSoundDef::RequestAuxSendProxy(this, ProxyRequest);
		}
	}
