enum EMeltdownSkydiveObstacleShapeType
{
	Box,
	Sphere
}

class UMeltdownSkydiveObstacleComponent : UHazeMovablePlayerTriggerComponent
{
	...
	UPROPERTY(EditInstanceOnly, Category = "Auto Generation")
	EMeltdownSkydiveObstacleShapeType ShapeToGenerate;
	...
	void GenerateShape()
	{
		...
		if(ShapeToGenerate == EMeltdownSkydiveObstacleShapeType::Sphere)
		{
		...
		else if(ShapeToGenerate == EMeltdownSkydiveObstacleShapeType::Box)
		{
