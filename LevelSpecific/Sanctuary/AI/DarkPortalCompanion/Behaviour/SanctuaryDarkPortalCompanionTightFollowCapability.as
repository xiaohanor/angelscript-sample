class USanctuaryDarkPortalCompanionTightFollowCapability : UHazeCapability
{
	...
	void ComposeMovement(float DeltaTime)
	{
		...
		{	
			...
			AccWorldRotation.AccelerateTo(CompanionComp.Player.ActorRotation, Settings.TurnDuration, DeltaTime);
