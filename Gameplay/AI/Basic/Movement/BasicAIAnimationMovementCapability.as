class UBasicAIAnimationMovementCapability : UBasicAIMovementCapability
{	
	...
	void InitializeMove(float DeltaTime)
	{
		...
		// TODO: There is a Mesh.InitializeMoveRatio which we should use to simplify move ratio handling. 
		// The sequence we want to get move ratio from can be dug out from anim request via anim instance.
	}
	...
	{		
		...
		for (FHazePlayingAnimationData AnimData : Animations)
		{
			...
			if (!AnimData.Sequence.IsMoveRatioEnabled())
				continue;
