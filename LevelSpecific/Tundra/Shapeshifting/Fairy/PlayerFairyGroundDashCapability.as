...
class UPlayerFairyGroundDashCapability : UHazePlayerCapability
{
	...
	UPlayerFairyGroundDashComponent StepDashComp;
	...
	void Setup()
	{
		...
		StepDashComp = UPlayerFairyGroundDashComponent::Get(Player);
	...
	void OnActivated(FStepDashActivationParams ActivationParams)
	{
		...
		UTundraPlayerFairyEffectHandler::Trigger_GroundDash_Started(FairyComp.FairyActor);
	}
	...
	void OnDeactivated(FStepDashDeactivationParams DeactivationParams)
	{
		...
		UTundraPlayerFairyEffectHandler::Trigger_GroundDash_Stopped(FairyComp.FairyActor);
	}
