...
class UPlayerFairyGroundDashComponent : UActorComponent
{
	UPROPERTY(NotVisible)
	UPlayerFairyGroundDashSettings Settings;	
	UPROPERTY()
	UPlayerFairyGroundDashSettings DefaultSettings;	
	UPROPERTY()
	...
	void BeginPlay()
	{
		Settings = UPlayerFairyGroundDashSettings::GetSettings(Cast<AHazeActor>(Owner));
		Player = Cast<AHazePlayerCharacter>(Owner);
		Player.ApplySettings(DefaultSettings, this);
