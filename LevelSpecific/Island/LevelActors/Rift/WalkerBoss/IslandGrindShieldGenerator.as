event void FAIslandGrindShieldGeneratorSignature();

class AIslandGrindShieldGenerator : AHazeActor
{
...
UCLASS(Abstract)
class UAIslandGrindShieldGeneratorEffectHandler : UHazeEffectEventHandler
{
