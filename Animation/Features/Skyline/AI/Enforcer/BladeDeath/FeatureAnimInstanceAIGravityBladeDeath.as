UCLASS(Abstract)
class UFeatureAnimInstanceAIGravityBladeDeath : UFeatureAnimInstanceAIBase
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureAIGravityBladeDeath Feature;
	...
	void BlueprintInitializeAnimation()
	{
		Super::BlueprintInitializeAnimation();
			ULocomotionFeatureAIGravityBladeDeath NewFeature = GetFeatureAsClass(ULocomotionFeatureAIGravityBladeDeath);
