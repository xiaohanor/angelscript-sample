...
class UAdultDragonFlightSettings : UHazeComposableSettings
{
	...
	// Maximum speed
	// Cannot be exceeded by flying downwards
	UPROPERTY()
	float MaxSpeed = 10000;

	// Minimum speed
	// Cannot go slower than this even if flying upwards
	UPROPERTY()
	float MinSpeed = 9000;

	// How much speed is gained per second at all times
	UPROPERTY()
	...
	UPROPERTY()
	float RotationDurationDuringInput = 3.0;
