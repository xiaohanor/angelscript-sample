class AMeltdownBossBaseAttackScaleActor : AHazeActor
{
	...
	void BeginPlay()
	{
		StartPos = StartPosMesh.RelativeScale3D;
		TargetPos = FVector(DesiredScaleX, DesiredScaleY, DesiredScaleZ);
	...
	{
		StartPosMesh.RelativeScale3D = Math::Lerp(StartPos,TargetPos, Alpha);
	}
