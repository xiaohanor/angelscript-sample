UCLASS(Abstract)
class UFeatureAnimInstanceTreeGuardianFlowerInteract : UHazeFeatureSubAnimInstance
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureTreeGuardianFlowerInteract Feature;
	...
	{
		ULocomotionFeatureTreeGuardianFlowerInteract NewFeature = GetFeatureAsClass(ULocomotionFeatureTreeGuardianFlowerInteract);
