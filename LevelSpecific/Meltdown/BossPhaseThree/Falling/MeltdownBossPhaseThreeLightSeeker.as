class AMeltdownBossPhaseThreeLightSeeker : AHazeActor
{
	...
	//	SetActorControlSide(Game::Mio);
		...
		MoveWorm.BindUpdate(this, n"UpdateWorm");

		Trigger.OnActorBeginOverlap.AddUFunction(this, n"OnOverlap");
	}
	...
	void UpdateSpline()
	{
		...
		FVector LastPoint = Math::Lerp(FirstPoint, Head.WorldLocation,Speed);
	...
	UFUNCTION()
	private void UpdateWorm(float CurrentValue)
	{
		Speed = Math::Lerp(0.0, 1.0, CurrentValue);
	}
