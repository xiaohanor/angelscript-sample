class UGravityWhipDragTutorialCapability : UHazePlayerCapability
{
	...
	void OnActivated()
	{		
		TListedActors<AGravityWhipTutorialActor> GrabTutorials;
		auto GrabLocation = GravityWhipUserComponent.Grabs[0].TargetComponents[0];
		Player.ShowTutorialPromptWorldSpace(GravityWhipTutorialComponent.PromptDragVertical, this, GrabLocation,  GravityWhipTutorialComponent.AttachOffset, GravityWhipTutorialComponent.ScreenSpaceOffset);
