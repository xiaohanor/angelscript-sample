...
class UEnforcerFindBalancedTargetBehaviour : UBasicBehaviour
{
	...
	void TickActive(float DeltaTime)
	{
		...
		if (Target != nullptr)
		{
			...
			bool bNewTarget = (Target != TargetComp.Target);
			TargetComp.SetTarget(Target);
			if (bNewTarget)
				CrumbChangeTarget(Target);
			Cooldown.Set(1.0);
			return;
		}
	}
	...
	{
		UEnforcerEffectHandler::Trigger_OnTargetSighted(Owner); 		

		// Now is a good time to match control side with target
