class UIslandPunchotronSidescrollerFallEntranceBehaviour : UBasicBehaviour
{
	...
	void OnActivated()
	{
		...
		LandingComp.BlockLandingEffect(this);
	...
	void OnDeactivated()
	{
		...
		LandingComp.UnblockLandingEffect(this);
	}
	...
	void TickActive(float DeltaTime)
	{
		...
		const float AnimationGroundContactTime = 0.05;
		...
		if (HitResult.bBlockingHit)
		{
			...
			{
				// Local animation clearing for remote.
				AnimComp.ClearFeature(this);
