class UIslandRedBlueAssaultFireCapability : UHazePlayerCapability
{
	...
	void TickActive(float DeltaTime)
	{
		...
		ForceFeedback.RightTrigger = AssaultSettings.RumbleAmount;
		ForceFeedback.RightMotor = AssaultSettings.RumbleAmount;
