struct FSanctuaryCompanionAviationStartDeactivateParams
{
	bool bNatural = false;
	FVector Destination;
}

class USanctuaryCompanionAviationStartPlayerCapability : UHazePlayerCapability
{
	// Crumb 
	...
	UFUNCTION(BlueprintOverride)
	bool ShouldDeactivate(FSanctuaryCompanionAviationStartDeactivateParams& Params) const
	{
	...
	UFUNCTION(BlueprintOverride)
	void OnDeactivated(FSanctuaryCompanionAviationStartDeactivateParams Params)
	{
