event void FSummitWeightedLiftSignature();

class ASummitWeightedLift : AHazeActor
{
	...
	UPROPERTY()
	FSummitWeightedLiftSignature OnActivated;

	UPROPERTY()
	FSummitWeightedLiftSignature OnReachedFirstDestination;

	UPROPERTY()
	FSummitWeightedLiftSignature OnReachedSecondDestination;
