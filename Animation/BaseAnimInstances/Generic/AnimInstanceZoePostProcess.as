class UAnimInstanceZoePostProcess : UAnimInstance
{
	...
	float HairPhysicsAlphaTarget = 0.4;
	...
	void BlueprintUpdateAnimation(float DeltaTime)
	{
		...
		HairPhysicsAlpha = bIsControlledByCutscene ? HairPhysicsAlphaTarget : 0;
		HairPhysicsAlpha *= HairWeight;
	}
}