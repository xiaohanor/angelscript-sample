class AMoonMarketFlowerTutorialVolume : AHazeActor
{
	                            ...
	                            const FHitResult&in SweepResult)
	{
		...
		UMoonMarketPlayerFlowerSpawningComponent::Get(Player).bShowPaintingTutorial = true;
	}
	                          ...
	                          UPrimitiveComponent OtherComp, int OtherBodyIndex)
	{
		...
		UMoonMarketPlayerFlowerSpawningComponent::Get(Player).bShowPaintingTutorial = false;
	}
};