...
class USnowMonkeyLedgeGrabSettings : UHazeComposableSettings
{
	//Shimmy

	//are we allowed to shimmy sideways at all during a ledgegrab
	UPROPERTY()
	bool bShimmyAllowed = false;
	...
	//
	UPROPERTY()
	float ShimmyDashDuration = 0.0;
	//
	UPROPERTY()
	float ShimmyDashDistance = 0.0;

	//
	UPROPERTY()
	float ShimmyDashExitSpeed = 0.0;
