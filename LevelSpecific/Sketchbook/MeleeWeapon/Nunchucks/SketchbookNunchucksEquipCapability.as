 ...
 */
class USketchbookNunchucksEquipCapability : UHazePlayerCapability
{
    ...
    void OnActivated()
    {
        USketchbookNunchucksPlayerComponent::Get(Player).EquipWeapon();
    }

    UFUNCTION(BlueprintOverride)
    void OnDeactivated()
    {
        USketchbookNunchucksPlayerComponent::Get(Player).UnequipWeapon();
    }
}