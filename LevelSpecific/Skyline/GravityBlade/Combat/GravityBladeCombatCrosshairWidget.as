UCLASS(Abstract)
class UGravityBladeCombatCrosshairWidget : UTargetableWidget
{
	...
	private UGravityBladeCombatTargetComponent CurrentTarget;
	...
	{
		UGravityBladeCombatTargetComponent Target = Cast<UGravityBladeCombatTargetComponent>(TargetablesComp.GetPrimaryTargetForCategory(GravityBladeCombat::TargetableCategory));
	...
	void OnTargetChanged(UGravityBladeCombatTargetComponent NewTarget)
	{
