struct FLightBirdCompanionDiscSlideFollowParams
{
	bool bTeleport;
	FVector Destination;
}

class USanctuaryLightBirdCompanionDiscSlideFollowCapability : UHazeCapability
{
	...
	UFUNCTION(BlueprintOverride)
	bool ShouldActivate(FLightBirdCompanionDiscSlideFollowParams& OutParams) const
	{
	...
	UFUNCTION(BlueprintOverride)
	void OnActivated(FLightBirdCompanionDiscSlideFollowParams Params)
	{
		...
		ULightBirdEventHandler::Trigger_OnCompanionFollowSlidingDiscStart(Owner);
	}
	...
	void OnDeactivated()
	{
		...
		ULightBirdEventHandler::Trigger_OnCompanionFollowSlidingDiscStop(Owner);
	}
