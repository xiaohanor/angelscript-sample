class UDragonSwordCombatGroundRushCapability : UHazePlayerCapability
{
...
// 	default CapabilityTags.Add(DragonSwordCapabilityTags::DragonSwordGroundRush);
...
// 		if(CombatComp.PendingAttackData.AttackType != EDragonSwordCombatAttackType::GroundRush)
// 			return false;
...
// 	{
// 		if (!CombatComp.IsActiveAttackType(EDragonSwordCombatAttackType::GroundRush))
// 			return true;
...
// 		const float DistanceToTarget = Player.ActorLocation.Distance(TargetLocation);
...
// 			if(HasControl())
// 			{
// 				const FVector NewLocation = Math::Lerp(Player.ActorLocation, TargetLocation, Alpha);
