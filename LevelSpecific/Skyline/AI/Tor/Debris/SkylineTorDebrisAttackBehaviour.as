...
struct FSkylineTorDebrisAttackDebrisData
{
	ASkylineTorDebris Debris;
	FHazeAcceleratedVector AccDebrisLocation;
	FVector2D Offset;
}

class USkylineTorDebrisAttackBehaviour : UBasicBehaviour
{	
...
enum ESkylineTorDebrisAttackMode
{
	Single,
	Multi
}