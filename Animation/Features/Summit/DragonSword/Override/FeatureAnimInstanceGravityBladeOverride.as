UCLASS(Abstract)
class UFeatureAnimInstanceDragonSwordOverride : UHazeFeatureSubAnimInstance
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureDragonSwordOverride Feature;
	...
	{
		ULocomotionFeatureDragonSwordOverride NewFeature = GetFeatureAsClass(ULocomotionFeatureDragonSwordOverride);
