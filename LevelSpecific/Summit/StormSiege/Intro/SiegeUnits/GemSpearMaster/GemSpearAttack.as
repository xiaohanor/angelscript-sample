class AGemSpearAttack : AHazeActor
{
	...
	float AttackMoveSpeed = 8000.0;
	float Speed;
	float AttackAcceleration = 7000.0;
	...
	void CheckForHits()
	{
		...
		if (Hit.bBlockingHit)
		{
			AGemSpearAttack OtherSpear = Cast<AGemSpearAttack>(Hit.Actor);
			...
			if (OtherGem == nullptr && OtherSpear == nullptr && OtherMetal == nullptr)
			{
