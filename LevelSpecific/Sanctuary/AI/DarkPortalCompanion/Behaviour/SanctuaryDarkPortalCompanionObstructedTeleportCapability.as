struct FDarkPortalCompanionObstructedTeleportParams
{
	FVector TeleportLoc;
	FVector TeleportVelocity;
}

class USanctuaryDarkPortalCompanionObstructedTeleportCapability : UHazeCapability
{
	...
	UFUNCTION(BlueprintOverride)
	bool ShouldActivate(FDarkPortalCompanionObstructedTeleportParams& OutParams) const
	{
	...
	UFUNCTION(BlueprintOverride)
	void OnActivated(FDarkPortalCompanionObstructedTeleportParams Params)
	{
