class USummitBallFlyerGuardSplineBehaviour : UBasicBehaviour
{
	...
	USummitBallFlyerSettings SwarmSettings;
	...
	{
		Super::Setup();
		SwarmSettings = USummitBallFlyerSettings::GetSettings(Owner);
		BallPlayer = Game::Zoe;
	...
	void TickActive(float DeltaTime)
	{
		...
		FVector DestOffset = SwarmSettings.GuardSplineOffset;
