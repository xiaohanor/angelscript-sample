class AMeltdownBossLaserSpawner : AHazeActor
{
	...
	TSubclassOf<AMeltdownBossPhaseOneStraightLaser> Missile;
	...
	void ShootMissile()
	{
		...
		AMeltdownBossPhaseOneStraightLaser MissileSpawned = Cast<AMeltdownBossPhaseOneStraightLaser> (SpawnActor(Missile, MissileSpawnLocation, ActorRotation, bDeferredSpawn = true));
