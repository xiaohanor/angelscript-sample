class UPlayerSwimmingSettings : UHazeComposableSettings
{
	UPROPERTY(Category = Swimming)
	float SwimmingCapsuleRadius = 48;
	...
	UPROPERTY(Category = Underwater)
	float UnderwaterVerticalDesiredSpeedInterpSpeed = 1.6;
	...
	UPROPERTY(Category = Surface)
	float SurfaceDesiredSpeed = 400.0;
	
	UPROPERTY(Category = Surface)
	float SurfaceMinimumSpeed = 200;

	UPROPERTY(Category = Surface)
	float SurfaceDesiredSpeedInterpSpeed = 2;

	UPROPERTY(Category = Surface)
	float SurfaceCooldown = 0;
	...
	UPROPERTY(Category = Surface)
	float VerticalVelocityForUnderWaterSwim = -500;
	...
	UPROPERTY(Category = "General Swimming", AdvancedDisplay)
	bool bAllowFollowMovement = false;

	UPROPERTY(Category = "General Swimming", AdvancedDisplay)
	bool bCurrentSwimmingEnabled = false;
