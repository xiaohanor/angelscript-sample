...
class UWorld_Skyline_Shared_Interactable_GravityWhip_Movable_DragableGrappleLaunch_SoundDefAdapter : USkylineDraggableGrappleLaunchEventHandler
{
	...
	UFUNCTION(BlueprintOverride)
	void OnConstrainHitHighAlpha(FSkylineDraggableGrappleLaunchConstrainHit InParams)
	{
	...
	UFUNCTION(BlueprintOverride)
	void OnConstrainHitLowAlpha(FSkylineDraggableGrappleLaunchConstrainHit InParams)
	{
		FGravityWhipMovableParams GravityWhipParams;
		GravityWhipParams.HitStrength = InParams.HitStrength;
