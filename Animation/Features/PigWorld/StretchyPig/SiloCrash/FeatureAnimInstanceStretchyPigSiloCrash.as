UCLASS(Abstract)
class UFeatureAnimInstanceStretchyPigSiloCrash : UHazeFeatureSubAnimInstance
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureStretchyPigSiloCrash Feature;
	...
	{
		ULocomotionFeatureStretchyPigSiloCrash NewFeature = GetFeatureAsClass(ULocomotionFeatureStretchyPigSiloCrash);
