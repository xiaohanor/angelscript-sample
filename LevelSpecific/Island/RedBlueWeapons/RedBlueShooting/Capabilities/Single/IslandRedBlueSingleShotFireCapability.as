class UIslandRedBlueSingleShotFireCapability : UHazePlayerCapability
{
	...
	EIslandRedBlueWeaponHandType StartLastWeaponFired;
	...
	bool ShouldDeactivate() const
	{
		...
		// Last weapon fired is different from when we started this capability, means that we have fired one bullet so we should deactivate
		if(WeaponUserComponent.LastWeaponFired != StartLastWeaponFired)
			return true;
	...
	void OnActivated()
	{
		...
		StartLastWeaponFired = WeaponUserComponent.LastWeaponFired;
	}
	...
	void TickActive(float DeltaTime)
	{
		...
		ForceFeedback.RightTrigger = SingleShotSettings.RumbleAmount;
		ForceFeedback.RightMotor = SingleShotSettings.RumbleAmount;
