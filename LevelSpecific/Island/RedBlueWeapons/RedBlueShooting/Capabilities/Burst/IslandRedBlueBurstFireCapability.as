class UIslandRedBlueBurstFireCapability : UHazePlayerCapability
{
	...
	bool ShouldDeactivate() const
	{
		...
		// Commented this out because we always want to fire a full burst as soon as you press input.
		// if(!IsActioning(ActionNames::PrimaryLevelAbility))
		// 	return true;

		if(ActiveDuration > BurstSettings.BurstLength)
			return true;
	...
	void TickActive(float DeltaTime)
	{
		...
		ForceFeedback.RightTrigger = BurstSettings.RumbleAmount;
		ForceFeedback.RightMotor = BurstSettings.RumbleAmount;
