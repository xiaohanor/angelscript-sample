class UIslandRedBlueBurstSettings : UHazeComposableSettings
{
	UPROPERTY(Category = "Shooting")
	float BurstLength = 0.39;
	...
	UPROPERTY(Category = "Bullet")
	float StartCoolDownBetweenBullets = 0.06;

	// How long between each projectile until we can shoot again
	UPROPERTY(Category = "Bullet")
	float TargetCoolDownBetweenBullets = 0.12;
