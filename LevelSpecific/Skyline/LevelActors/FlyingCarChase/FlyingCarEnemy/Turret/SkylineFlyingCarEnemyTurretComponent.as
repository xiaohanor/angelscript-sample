...
class USkylineFlyingCarEnemyTurretComponent : USceneComponent
{
	...
	float PlayerDamage = 0.10;

	private ASkylineFlyingCarEnemy CarEnemy;
	TArray<USkylineFlyingCarEnemyTurretMuzzleComponent> MuzzleComponents;
	...
	FVector GetTargetLocation() const
	{
		...
		if(SkylineFlyingCarEnemy::GetPlayerHealth() > SkylineFlyingCarEnemy::Turret::MinimumHealthToFireAccurately)
		{
	...
	USkylineFlyingCarEnemyTurretMuzzleComponent GetCurrentMuzzle() const
	{
	...
	void StartReload(float AdditionalReloadTime = 0.0)
	{
		StartReloadTime = Time::GameTimeSeconds + AdditionalReloadTime;
	}
