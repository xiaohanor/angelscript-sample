 ...
 */
class UPinballMagnetBossBallAboveAttractionMode : UMagnetDroneAttractionMode
{
	...
	{
		return TargetData.GetTargetLocation() + TargetData.GetTargetImpactNormal() * 300;
	}
};