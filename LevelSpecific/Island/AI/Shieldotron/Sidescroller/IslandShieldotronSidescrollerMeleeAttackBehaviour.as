class UIslandShieldotronSidescrollerMeleeAttackBehaviour : UBasicBehaviour
{
	...
	void PreTick(float DeltaTime)
	{
		...
		if (((Owner.ActorLocation.IsWithinDist(Game::Mio.ActorLocation, Settings.MeleeAttackActivationRange) && Math::Abs(Owner.ActorLocation.Z - Game::Mio.ActorLocation.Z) < 150)	&& TargetComp.IsValidTarget(Game::Mio) )
			|| ((Owner.ActorLocation.IsWithinDist(Game::Zoe.ActorLocation, Settings.MeleeAttackActivationRange) && Math::Abs(Owner.ActorLocation.Z - Game::Zoe.ActorLocation.Z) < 150) && TargetComp.IsValidTarget(Game::Zoe) )
			)
