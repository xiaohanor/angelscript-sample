class UDesertRopeTensionerInteractionCapability : UInteractionCapability
{
	...
	ADesertRopeTensioner RopeTensioner;
	...
	{
		if (!CheckInteraction.Owner.IsA(ADesertRopeTensioner))
			return false;
	...
	void OnActivated(FInteractionCapabilityParams Params)
	{
		...
		RopeTensioner = Cast<ADesertRopeTensioner>(Params.Interaction.Owner);
	...
	void OnEnterBlendedIn()
	{
		...
		UDesertRopeTensionerEventHandler::Trigger_OnPlayerAttached(RopeTensioner);
		UDesertRopeTensionerPlayerEventHandler::Trigger_OnPlayerAttached(Player);
	}
