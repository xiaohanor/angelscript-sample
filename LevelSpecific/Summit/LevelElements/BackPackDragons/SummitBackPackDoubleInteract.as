event void FOnOnActivated();event void FOnOnDectivated();event void FOnOnReady();
class ASummitBackPackDoubleInteract : AHazeActor
{
	UPROPERTY()
	FOnOnActivated OnActivated;

	UPROPERTY()
	FOnOnActivated OnDeactivated;
	...
	default CapabilityComp.DefaultCapabilities.Add(n"SummitBackPackDoubleInteractCapability");
...
class USummitBackPackDoubleInteractCapability : UHazeCapability
{
	...
	ASummitBackPackDoubleInteract BackpackInteractActor;
	...
	void Setup()
	{
		BackpackInteractActor = Cast<ASummitBackPackDoubleInteract>(Owner);
	}
