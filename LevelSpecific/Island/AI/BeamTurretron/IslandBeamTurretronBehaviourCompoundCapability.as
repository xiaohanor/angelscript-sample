class UIslandBeamTurretronBehaviourCompoundCapability : UHazeCompoundCapability
{
			...
			.Add(UHazeCompoundSelector()
				...
				.Try(UHazeCompoundSelector()
					...
					.Try(UHazeCompoundRunAll()
						.Add(UIslandBeamTurretronTrackTargetBehaviour()) 
						.Add(UIslandBeamTurretronAttackBehaviour())
					)
					.Try(UHazeCompoundSelector()							
