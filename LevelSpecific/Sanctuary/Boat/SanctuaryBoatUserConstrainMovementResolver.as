class USanctuaryBoatUserConstrainMovementResolver : USteppingMovementResolver
{
	...
	private void ConstrainDeltaToWithinBoat()
	{
		...
		auto Boat = Cast<ASanctuaryBoat>(IterationState.PhysicsState.GroundContact.Actor);
		if(Boat == nullptr)
			return;
		...
		FVector RelativeTargetLocation = Boat.Pivot.WorldTransform.InverseTransformPositionNoScale(TargetLocation);
		...
		FVector ClampedTargetLocation = Boat.Pivot.WorldTransform.TransformPositionNoScale(RelativeTargetLocation);
