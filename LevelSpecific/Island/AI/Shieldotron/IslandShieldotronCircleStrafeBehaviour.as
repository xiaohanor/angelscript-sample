...
class UIslandShieldotronCircleStrafeBehaviour : UBasicBehaviour
{
	...
	bool ShouldActivate() const
	{
		...
		if (!TargetComp.HasValidTarget())
			return false;
		if (!Owner.ActorLocation.IsWithinDist(TargetComp.Target.ActorLocation, Math::Min(Settings.CircleStrafeEnterRange, Settings.CircleStrafeMaxRange)))
			return false;
	...
	bool ShouldDeactivate() const
	{
		...
		if (!TargetComp.HasValidTarget())
			return true;
		if (!Owner.ActorLocation.IsWithinDist(TargetComp.Target.ActorLocation, Settings.CircleStrafeMaxRange))
			return true;
		if (Owner.ActorLocation.IsWithinDist(TargetComp.Target.ActorLocation, Settings.CircleStrafeMinRange))
			return true;
		return false;		
