class UMoonMarketPlayerExitYarnBallCapability : UHazePlayerCapability
{
	...
	bool ShouldActivate() const
	{
		...
		if (ALLOW_ROLL_AFTER_LANDING)
		{
			...
			if (bTimedAfterLanding && PerchComp.GetState() == EPlayerPerchState::Inactive)
			{
	...
	void TickActive(float DeltaTime)
	{
		if (MoveComp.PrepareMove(Movement))
		{
			if (HasControl())
			{
				...
				Movement.SetRotation(Dir.ToOrientationQuat());
