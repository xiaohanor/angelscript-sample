class UBasicFitnessCircleStrafeBehaviour : UBasicBehaviour
{
	...
	private FBasicFitnessCircleStrafeFlipResult ShouldFlip(FVector StrafeDest)
	{
		...
		bool bHasVisibility = PerceptionComp.Sight.VisibilityExists(Owner, TargetComp.Target, (StrafeDestNavMesh-Owner.ActorLocation));
...
struct FBasicFitnessCircleStrafeFlipResult
{
	bool bDoFlip = false;
	EBasicFitnessCircleStrafeFlipReason Reason = EBasicFitnessCircleStrafeFlipReason::None;
}

enum EBasicFitnessCircleStrafeFlipReason
{
	None,
	Movement,
	Visbility,
