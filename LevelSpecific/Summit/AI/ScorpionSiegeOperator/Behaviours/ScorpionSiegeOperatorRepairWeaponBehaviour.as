class UScorpionSiegeOperatorRepairWeaponBehaviour : UBasicBehaviour
{
	...
	{
		OperationComp.TargetWeapon.RepairComp.RepairTime += DeltaTime;
		AnimComp.RequestFeature(LocomotionFeatureAIScorpionSiegeOperatorTags::Repair, EBasicBehaviourPriority::Medium, this);
	}
}