class USkylineTorChangeHoveringPhaseBehaviour : UBasicBehaviour
{
	...
	void OnActivated()
	{
		...
		Activations++;
		if(Activations <= 1 || PhaseComp.SubPhase == ESkylineTorSubPhase::HoveringShort)
		{
			DeactivateBehaviour();
			return;
		}

		PhaseComp.SetSubPhase(ESkylineTorSubPhase::HoveringShort);
	}
