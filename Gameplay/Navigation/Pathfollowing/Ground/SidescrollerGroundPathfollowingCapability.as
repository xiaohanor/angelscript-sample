...
class USidescrollerGroundPathfollowingCapability : UHazeCapability
{
	...
	bool IsAt(int Index)
	{
		...
		// Compare spline locations
		OwnLoc = DestinationComp.FollowSpline.GetClosestSplineWorldLocationToWorldLocation(OwnLoc);
		PathLoc = DestinationComp.FollowSpline.GetClosestSplineWorldLocationToWorldLocation(PathLoc);
