class USummitAIGentlemanMeleeScoreCapability : UHazeCapability
{
	...
	// 	float Score = SummitGentlemanToken::GetMeleeScore(TargetComp.Target, Owner);
	// 	Debug::DrawDebugString(Owner.ActorCenterLocation + FVector::UpVector * 100.0, "" + Score, FLinearColor::Teal);
	// }
	...
	bool ShouldActivate() const
	{
		...
		if (!TargetComp.GentlemanComponent.IsClaimingToken(GentlemanToken::Melee, Owner))
			return false;
	...
	void OnDeactivated()
	{
		TokenComp.SetTokenScore(GentlemanToken::Melee, 0.0);
	}
	...
	void UpdateScore()
	{
		...
		float Score = SummitGentlemanToken::GetMeleeScore(TargetComp.Target, Owner);
		TokenComp.SetTokenScore(GentlemanToken::Melee, Score);
	}
}