class USkylineEnforcerStickyBombLauncherSettings : UHazeComposableSettings
{
	// StickyBomb damage
	UPROPERTY(Category = "StickyBomb")
	float StickyBombDamage = 0.2;

	// Time before StickyBomb explodes
	UPROPERTY(Category = "StickyBomb")
	float StickyBombDuration = 1.5;
	...
	UPROPERTY(Category = "StickyBomb")
	float StickyBombDamagePlayer = 0.5;
	...
	UPROPERTY(Category = "BillboardFauxPhysics")
	float BillboardBombExplosionForce = 200.0;
}
