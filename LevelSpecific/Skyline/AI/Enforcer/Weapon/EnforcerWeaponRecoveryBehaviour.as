class UEnforcerWeaponRecoveryBehaviour : UBasicBehaviour
{
	...
	{		
		...
		UEnforcerWeaponComponent Weapon = EnforcerWeapon::Get(Owner);
		UEnforcerWeaponEffectHandler::Trigger_OnReload(Weapon.WeaponActor, FEnforcerWeaponEffectReloadParams(RecoveryDuration));
