class USkylineCarGunnerPlayerListenerCapability : UHazePlayerCapability
{
	...
	void Setup()
	{
		...
		CarGunnerComponent = USkylineFlyingCarGunnerComponent::Get(Player);
	}

	UFUNCTION(BlueprintOverride)
	bool ShouldActivate() const
	{
		if (CarGunnerComponent.Car == nullptr)
			return false;
