...
class USnowMonkeyLedgeGrabCancelCapability : UHazePlayerCapability
{
	...
	{	
		...
		if (LedgeGrabComp.State != ESnowMonkeyLedgeGrabState::Cancel)
			return true;
	...
	void OnActivated()
	{
		...
		LedgeGrabComp.State = ESnowMonkeyLedgeGrabState::Cancel;
