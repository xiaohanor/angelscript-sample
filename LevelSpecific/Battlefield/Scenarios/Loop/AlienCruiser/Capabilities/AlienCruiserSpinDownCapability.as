class UAlienCruiserSpinDownCapability : UHazeChildCapability
{
	...
	bool ShouldDeactivate() const
	{
		...
		if(ActiveDuration >= Cruiser.SpinDownDuration)
			return true;
	...
	void OnDeactivated()
	{
		...
		Cruiser.bHasShot = true;
		Cruiser.bShouldShoot = false;
	}
	...
	void TickActive(float DeltaTime)
	{
		...
		Cruiser.CurrentRotationSpeed = Math::Lerp(Cruiser.ShootingRotationSpeed, Cruiser.IdleRotationSpeed, Alpha);
