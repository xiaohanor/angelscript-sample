UCLASS(Abstract)
class UFeatureAnimInstanceStretchyPigSlideDash : UHazeFeatureSubAnimInstance
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureStretchyPigSlideDash Feature;
	...
	{
		ULocomotionFeatureStretchyPigSlideDash NewFeature = GetFeatureAsClass(ULocomotionFeatureStretchyPigSlideDash);
