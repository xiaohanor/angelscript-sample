class UGravityBikeFreeThrottleForceFeedbackCapability : UHazeCapability
{
	...
	void OnActivated()
	{
		UGravityBikeFreeEventHandler::Trigger_OnThrottleForceFeedbackStart(GravityBike);
	}

	UFUNCTION(BlueprintOverride)
	void OnDeactivated()
	{
		UGravityBikeFreeEventHandler::Trigger_OnThrottleForceFeedbackEnd(GravityBike);
	}
