...
class UIslandDyadForceFieldCapability : UHazeCapability
{
	...
	void Setup()
	{
		...
		Settings = UIslandDyadSettings::GetSettings(Owner);
	...
	private void OnImpact(FIslandRedBlueImpactResponseParams Data)
	{
		...
		ForceFieldComp.TakeDamage(Settings.ForceFieldRedBlueDamage, Data.ImpactLocation, Instigator = Data.Player);
	}
