class USkylineTorHoveringSecondPhaseBehaviourCompoundCapability : UHazeCompoundCapability
{
	...
	bool ShouldActivate() const
	{
		if(PhaseComp.Phase != ESkylineTorPhase::Hovering)
			return false;
		if(PhaseComp.SubPhase != ESkylineTorSubPhase::HoveringSecond)
			return false;
		return true;
	}
	...
	UHazeCompoundNode GenerateCompound()
	{
		return 	UHazeCompoundSelector()
			.Try(USkylineTorOpportunityAttackBehaviour())
