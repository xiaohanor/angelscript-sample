...
UCLASS(Abstract)
class UFeatureAnimInstanceDragonSwordCombatStandardAttack : UHazeFeatureSubAnimInstance
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureDragonSwordCombatStandardAttack Feature;
	...
	{
		ULocomotionFeatureDragonSwordCombatStandardAttack NewFeature = GetFeatureAsClass(ULocomotionFeatureDragonSwordCombatStandardAttack);
