namespace SubTagGravityBladeHitReaction
{
	const FName Grapple = n"Grapple";
}

UCLASS(Abstract)
class UFeatureAnimInstanceAIGravityBladeHitReaction : UFeatureAnimInstanceAIBase
{
	// The Feature associated with this Feature Sub Anim Instance
	UPROPERTY(Transient, BlueprintHidden, NotEditable)
	ULocomotionFeatureAIGravityBladeHitReaction Feature;
	...
	void BlueprintInitializeAnimation()
	{
		...
		ULocomotionFeatureAIGravityBladeHitReaction NewFeature = GetFeatureAsClass(ULocomotionFeatureAIGravityBladeHitReaction);
	...
	void BlueprintUpdateAnimation(float DeltaTime)
	{
		...
		bIsGrappleHit = IsCurrentSubTag(SubTagGravityBladeHitReaction::Grapple);
