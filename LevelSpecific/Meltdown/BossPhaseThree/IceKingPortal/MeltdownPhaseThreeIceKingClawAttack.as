UCLASS(Abstract)
class AMeltdownPhaseThreeIceKingClawAttack : AHazeActor
{
	...
	void ActivateClawAttack()
	{
		...
		UMeltdownPhaseThreeIceKingClawAttackEffectHandler::Trigger_OnSpawned(this);
	}
	...
	private void OnKillBoxOverlap(AHazePlayerCharacter Player)
	{
		...
		UMeltdownPhaseThreeIceKingClawAttackEffectHandler::Trigger_OnKnockDown(this);
	}
...
class UMeltdownPhaseThreeIceKingClawAttackEffectHandler : UHazeEffectEventHandler
{
