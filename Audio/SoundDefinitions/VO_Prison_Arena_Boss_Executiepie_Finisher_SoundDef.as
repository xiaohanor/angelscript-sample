...
UCLASS(Abstract)
class UVO_Prison_Arena_Boss_Executiepie_Finisher_SoundDef : UHazeVOSoundDef
{
	...
	UFUNCTION(BlueprintEvent)
	void LaserEyesSweepStarted(FArenaBossLaserEyesSweepData ArenaBossLaserEyesSweepData){}
	...
	UFUNCTION(BlueprintEvent)
	void HandHackStateEnded(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void HandHackFinalPunch(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void HandHackPunch(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void HandHackCharged(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void HandHacked(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void HandHackStateEntered(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void FacePunchStateEnded(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void FacePunchFinalHit(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void FacePunchHit(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void FacePunchStateEntered(FArenaBossHandData ArenaBossHandData){}
	...
	UFUNCTION(BlueprintEvent)
	void FlameThrowerStopped(FArenaBossFlameThrowerData ArenaBossFlameThrowerData){}

	UFUNCTION(BlueprintEvent)
	void FlameThrowerStarted(FArenaBossFlameThrowerData ArenaBossFlameThrowerData){}
	...
	UFUNCTION(BlueprintEvent)
	void OnIntensityRequested(FCrowdIntensityRequest CrowdIntensityRequest){}

	UFUNCTION(BlueprintEvent)
	void HandHackStartCharge(FArenaBossHandData ArenaBossHandData){}

	UFUNCTION(BlueprintEvent)
	void HandHackStopCharge(FArenaBossHandData ArenaBossHandData){}
