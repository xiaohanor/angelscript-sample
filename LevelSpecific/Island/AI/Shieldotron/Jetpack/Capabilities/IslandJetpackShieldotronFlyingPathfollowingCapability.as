class UIslandShieldotronFlyingPathfollowingCapability : UHazeCapability
{
	default CapabilityTags.Add(n"Pathfinding");
	default CapabilityTags.Add(n"FlyingPathfinding");
	...
	void Setup()
	{
		...
		HazeOwner.ApplyDefaultSettings(BasicAIFlyingPathfindingMoveToSettings);
    ...
    {
		AHazeActor HazeOwner = Cast<AHazeActor>(Owner);
		HazeOwner.ApplySettings(BasicAIFlyingPathfindingMoveToSettings, this);
		Reset();
	}
