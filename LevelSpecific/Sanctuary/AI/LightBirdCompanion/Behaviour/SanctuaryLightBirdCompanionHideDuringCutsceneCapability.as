class USanctuaryLightBirdCompanionHideDuringCutsceneCapability : UHazeCapability
{
	...
	void OnDeactivated()
	{
		if (HasControl() && (CompanionComp.Player != nullptr))
		{
			...
			CrumbPlaceBehindCamera(LightBirdCompanion::GetWatsonTeleportLocation(ViewPlayer), ViewPlayer.ViewRotation);
		}
		if (CompanionComp.Player == nullptr)
			Restore();
	}
