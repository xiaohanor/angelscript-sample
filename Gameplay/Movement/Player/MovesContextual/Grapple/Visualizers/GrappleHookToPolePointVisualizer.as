#if EDITOR
class UGrappleHookToPolePointVisualizer : UHazeScriptComponentVisualizer
{
	default VisualizedClass = UGrappleToPolePointComponent;
    ...
    {
        UGrappleToPolePointComponent Comp = Cast<UGrappleToPolePointComponent>(Component);
        if (Comp == nullptr)
            return;
	...
	{
		auto Comp = Cast<UGrappleToPolePointComponent>(EditingComponent);
